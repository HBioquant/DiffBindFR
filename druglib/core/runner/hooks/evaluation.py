...
from druglib.utils import FileClient, is_seq_of
...
class EvalHook(Hook):
    ...
    Args:
        ...
        save_best: str, optional, if a metric is specified, it would measure
            ...
            on the test dataset. If `save_best` is `auto`, the first key of
            the returned `OrderedDict` result will be used. Default: None.
        ...
        test_fn: callable, optional, test a model with samples from a
            ...
            test function `engine.test_utils.single_gpu_inference` will be used.
            (default: None)
        ...
        file_client_args: dict, arguments to instantiate a FileClient.
            See :class:`druglib.io.FileClient` for details. Default: None.
    ...
    """
    # TODO: druglib modification is needed
    ...
    def __init__(
        ...
        if test_fn is None:
            from ..engine import single_gpu_inference
            self.test_fn = single_gpu_inference
        else:
        ...
        if less_keys is None:
            ...
            if not isinstance(less_keys, (list, tuple)):
                assert isinstance(less_keys, str)
                less_keys = (less_keys, )
            ...
            if key_indicator != 'auto':
                ...
                if key_indicator_lc in greater_keys:
                    ...
                    raise ValueError(f'Cannot infer the rule for key '
                                     ...
                                     f'must be specified.')
            # if key_indicator == 'auto', please see self.evaluate for details.
        self.rule = rule
    ...
    def _do_evaluate(
        ...
        # metric evaluate by dataset.evaluate function in self.evaluate
    ...
    def evaluate(
        ...
        eval_res: dict = self.dataloader.dataset.evaluate(
...
class DistEvalHook(EvalHook):
    ...
    def __init__(
        ...
        if test_fn is None:
            from ..engine import multi_gpu_inference
            test_fn = multi_gpu_inference
