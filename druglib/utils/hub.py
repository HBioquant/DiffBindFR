...
# Copy from https://github.com/open-mmlab/mmcv/blob/master/mmcv/mmcv/utils/hub.py
...
if TORCH_VERSION != 'parrots' and digit_version(TORCH_VERSION) < digit_version(
    ...
    import os, warnings, sys, zipfile, torch
    ...
    def _is_legacy_zip_format(filename) -> bool:
    ...
    def load_url(
            ...
            map_location:Union[Callable, dict] = None,
            progress:bool = True,
        ...
        Args:
            ...
            map_location:Union[Callable, dict]: A function or a dict specifying how to
            ...
            check_hash:bool: If True, the filename part of the URL
                ...
                Default: False
            file_name:str: name for the downloaded file. Filename
