...
# Copied from https://github.com/pyg-team/pytorch_geometric/blob/master/torch_geometric/data/batch.py
import inspect
...
from .collate import data_collate
...
class Batch(metaclass=DynamicInheritance):
    ...
    Inherits from :class:`Data` or :class:`HeteroData`.
    ...
    def from_data_list(cls, data_list: List[BaseData],
        ...
        """
        Constructs a :class:`Batch` object from a Python list of
            :class:`Data` or :class:`HeteroData` objects.
        ...
        batch, slice_dict, inc_dict = data_collate(
            cls,
            data_list = data_list,
            increment = True,
    ...
    def get_example(self, idx: int) -> BaseData:
        """
        Gets the :class:`Data` or :class:`HeteroData` object at index :obj:`idx`.
        The :class:`Batch` object must have been created via :meth:`from_data_list`
    ...
    def index_select(self, idx: IndexType) -> List[BaseData]:
        """
        Creates a subset of :class:`Data` or :class:`HeteroData` objects
            from specified indices :obj:`idx`.
        Indices :obj:`idx` can be a slicing object, *e.g.*, :obj:`[2:5]`, a
            list, a tuple, or a :obj:`torch.Tensor` or :obj:`np.ndarray` of
            type long or bool.
        The :class:`Batch` object must have been created via :meth:`from_data_list`
    ...
    def to_data_list(self) -> List[BaseData]:
        """
        Reconstructs the list of :class:`Data` or :class:`HeteroData`
            objects from the :class:`Batch` object.
        The :class:`Batch` object must have been created via :meth:`from_data_list`
            in order to be able to reconstruct the initial objects.
        """
